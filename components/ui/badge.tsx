...
// Status chips use pill styling (rounded-full) per the 1health design system.
// Solid variants (default/secondary/destructive) for emphasis; soft semantic
// variants (success/warning/info) for status — soft bg + AA-readable text.
  ...
  'inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden',
  {
    variants: {
      variant: {
        ...
        success:
          'border-transparent bg-success/12 text-success-strong',
        warning:
          'border-transparent bg-warning/15 text-warning-strong',
        info:
          'border-transparent bg-info/12 text-info-strong',
      },
    },
    defaultVariants: {
      variant: 'default',
